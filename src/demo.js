...
if(document.getElementById("testCanvas")) {
    ...
    stage.addChild(container);
		console.log('in handle image', event);
		...
		//used to move the image should probably be used in tandom with mousedown
		...
		//enlarging picture when hovered over
